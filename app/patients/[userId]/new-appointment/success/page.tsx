...
const SuccessPage =async ({params:{userId}, searchParams}:SearchParamProps) => {
  ...
  return (
    <div className='w-full flex flex-col h-screen max-h-screen px-[5%]'>
        <div className='success-img'>
            <Link href={"/"}>
                <Image src={"/assets/icons/logo-full.svg"} alt='logo' width={1000} height={1000} className='w-fit h-10' />
            </Link>

            <section className='flex flex-col items-center'>
                <Image src={"/assets/gifs/success.gif"} height={300} width={200} alt='sucess' />
            ...
            <p>&copy; 2024 CarePlus Enoch Oyedeji</p>
