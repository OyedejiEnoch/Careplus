  ...
  return(
    ...
    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-12 flex-1">
        ...
        <section className="space-y-4">
            <h1 className="header text-white">Welcome👋
            !!...</h1>
        ...
        <CustomFormField 
                ...
                name={"address"}
                label="Address"
                placeholder="11th, street New Jersey"
        ...
        <div className="flex flex-col gap-6 xl:flex-row">
            <CustomFormField 
                ...
                placeholder="Mother has caner, Genetic rashes"
            />
            <CustomFormField 
                control={form.control} 
                fieldType={FormFieldType.TEXTAREA} 
